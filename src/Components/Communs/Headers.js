                    ...
                    <Container fluid className='border-0'>
                        ...
                        <Navbar.Collapse id="navbarScroll">
                            ...
                            <Nav className="d-flex justify-content-start">
                                ...
                                <Nav.Link onClick={()=>{navigate('/Carts/')}} className='d-flex justify-content-start align-items-center flex-wrap'><Badge bg="black"><BsCart4 className="mx-1 text-ligth" style={{fontSize:'25px'}} /><span className={panier>0?'text-primary d-flex align-items-end justify-content-end':'text-primary d-none align-items-end justify-content-end'}>{panier}</span></Badge><span className='d-lg-none ms-2'>PANIER</span></Nav.Link>
