    ...
    return(
        <>
            <div className='mx-5 my-5'>
                <h2 className='w-100' style={{borderBottom: '1px solid var(--bs-primary)'}}><BsInfoCircleFill className="me-2 text-dark" style={{fontSize:'40px'}}/>INFOS</h2>
                <div className="d-flex justify-content-evenly flex-column flex-lg-row flex-wrap my-4">
